...
package ie.com.certification.topic10.JFT10Ex4;
...
public class Test {
    public static void main(String[] args) {
        ...
        printMessage = String.format(message,"Sum: ",n1.sum(5,10));
        printMessage += String.format(message, "Divide: ", n1.divide(10,10));
        printMessage += String.format(message, "Multiply: ", n1.multiply(15,10));
        printMessage += String.format(message, "Remainder: ", n1.remainder(100,90));
