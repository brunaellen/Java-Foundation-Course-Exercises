...
package ie.com.certification.topic10.JFT10Ex5;

public class NumberRange {
    public String checkInRange(int lowerRangeValue, int upperRangeValue, int noToSearch ) {
        String message;
        if (noToSearch >= lowerRangeValue && noToSearch <=upperRangeValue) {
            message = "No. in range";
        } else {
            message = "No. not in range!";
        }
        return message;
    }
}
